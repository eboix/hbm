...
%      % pow_adj_hbm.pdf
     classifiers = {...
         ...
         {@nb_classifier, 'nb'}, ...
         {@pow_adj_classifier, 'pow (adj) none 0.55','no_clean',true,'pow_c',0.55}, ...
         {@pow_adj_classifier, 'pow (adj) none 0.65','no_clean',true,'pow_c',0.65}, ...
         };
     % {@pow_adj_classifier, 'pow (adj) none 0.6','no_clean',true,'pow_c',0.6}, ...
     % {@pow_adj_classifier, 'pow (adj) none 0.7','no_clean',true,'pow_c',0.7}, ...
     % {@pow_adj_classifier, 'pow (adj) none 0.5','no_clean',true,'pow_c',0.5}, ...
     % {@pow_adj_classifier, 'pow (adj) none 0.4','no_clean',true,'pow_c',0.4}, ...
