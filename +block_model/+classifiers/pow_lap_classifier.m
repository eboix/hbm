function [class_guess,vout] = pow_lap_classifier(obj,varargin)
% obj is hybrid_block_model object, graph object, or adjacency matrix to
% cluster using the laplacian of the powered graph.
% Optional parameters:
...
% vout is unchanged extra output from adj_classifier.
    ...
    [class_guess,vout] = pow_classifier(@lap_classifier,obj,varargin{:});
end