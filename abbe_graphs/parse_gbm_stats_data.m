...
% Cocktail GBM.
        classifiers = {...
            ...
            {'clean and pow norm lap', 'randwalk (clean 1) (pow 0.15)', 'clean_c',1,'pow_c',0.15},...
...
%                     };
        ...
        % {@sym_norm_adj_classifier, 'norm adj'}, ...
        % {@pow_adj_classifier, 'pow (adj) none 0.25','no_clean',true,'pow_c',0.25}, ...
